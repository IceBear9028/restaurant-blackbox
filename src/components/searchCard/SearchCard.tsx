...
export const SearchCard = ({ licenseId, address, phone, storeTitle, ...props }: SearchCardProps) => {
  return (
    <a className="mx-6 flex items-center justify-between border-b border-gray-100 py-10 lg:mx-8" {...props}>
      <div>
        ...
        <p className="mt-3 text-black-light lg:text-lg">{`인허가번호 : ${licenseId} ${phone && `/ 전화번호 : ${phone}`}`}</p>
